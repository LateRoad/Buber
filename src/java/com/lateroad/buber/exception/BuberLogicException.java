...
/**
 * The class {@code BuberLogicException} and its subclasses are a form of
 * {@code Throwable} that indicates conditions that a reasonable
 * application might want to catch. It's throws when logic of server actions is occur.
 * Used for send response with some kind of exception information to client side.
 *
 * @author LateRoad
 * @since JDK1.8
 */
