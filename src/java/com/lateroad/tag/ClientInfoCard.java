...
public class ClientInfoCard extends RequestContextAwareTag {
    ...
    protected int doStartTagInternal() throws Exception {
        ...
        try {
            ...
            out.write("        <i class=\"fa fa-fw fa-thumbs-o-up\"></i> " + bundle.getString("string-reputation") + ": " + client.getUserInfo().getClientInfo().getReputation() + "<br>");
            out.write("        <i class=\"fa fa-fw fa-handshake-o\"></i> " + bundle.getString("string-trips-count") + ": " + client.getUserInfo().getClientInfo().getTripsNumber());
            out.write("    </div>");
