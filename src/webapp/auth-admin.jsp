...
<head>
    ...
    <title><fmt:message key="admin-entrance"/></title>
</head>
...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="mx-auto mt-5">
            <h2><fmt:message key="entering-as-admin"/></h2>
            <form style="width: 500px">
                ...
                <button onclick="signIn('admin')" type="submit" class="btn btn-primary"><fmt:message
                        key="come-in"/></button>
            </form>
        </div>
    </div>
